...
public class SimulatorController {
    ...
    /** PATCH /simulator/config — 공정 속도(Tick Rate) 조절 */
    @PatchMapping("/config")
    ...
    /** POST /simulator/move/{vehicleId} — 특정 차량 즉시 다음 공정으로 강제 이동 */
    ...
    /** POST /simulator/error/line/{lineId} — 특정 라인 장애 강제 발생 */
    ...
    /** POST /simulator/error/clear — 모든 장애 복구 */
